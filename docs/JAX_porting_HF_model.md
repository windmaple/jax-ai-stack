...
Since the model is fairly large, you are going to need either **a Colab's high RAM instance** (which requires [Colab Pro subscription](https://colab.research.google.com/signup)) or **a [Kaggle](https://www.kaggle.com/) instance**.
